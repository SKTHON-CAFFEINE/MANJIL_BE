...
public class PromptFactory {
  ...
  public static String systemPromptKo() {
    return """
          ...
          {
            "cards":[
              {"exerciseId": number, "name": string, "value": number}
            ],
            "disclaimer":"string"
          }
  ...
  public static String userPromptKoWithCondition(
    ...
    return """
      ...
      요구사항:
      - cards는 반드시 정확히 4개.
      - 각 card는 {"exerciseId","name","value"}만 포함(sets 절대 포함하지 말 것).
